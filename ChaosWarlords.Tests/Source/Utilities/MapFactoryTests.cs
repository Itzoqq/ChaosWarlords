...
namespace ChaosWarlords.Tests.Source.Utilities
{
    ...
    public class MapFactoryTests
    {
        ...
        public void LoadFromData_CreatesCorrectSitesAndAssignsNodes()
        {
            ...
            Assert.HasCount(2, site.Nodes, "Site should contain 2 nodes.");
            Assert.Contains(node2, site.Nodes, "Site should contain Node 2.");
            Assert.Contains(node3, site.Nodes, "Site should contain Node 3.");
        }
    }
}