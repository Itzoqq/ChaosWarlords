...
namespace ChaosWarlords.Tests.Integration.Factories
{
  ...
  public class MapFactoryTests
  {
    ...
    public void LoadFromData_CreatesCorrectNodesAndConnections()
    {
      ...
      var (nodes, sites, _) = MapFactory.LoadFromData(MockMapJson, Utilities.TestLogger.Instance);
    ...
    public void LoadFromStream_ParsesDataCorrectly()
    {
      ...
      {
        // Act
        var (nodes, sites, _) = MapFactory.LoadFromStream(stream, Utilities.TestLogger.Instance);
    ...
    {
      // Act
      var (nodes, sites, _) = MapFactory.CreateTestMap(Utilities.TestLogger.Instance);
