...
namespace ChaosWarlords.Tests.Managers
{
    ...
    public class TurnManagerTests
    {
        ...
        public void Constructor_InitializesPlayersAndStartsFirstTurn()
        {
            ...
            var manager = new TurnManager(players, mockRandom, Utilities.TestLogger.Instance);
        ...
        public void Create_ThrowsException_IfPlayerListEmpty()
        {
            ...
            {
                var mockRandom = Substitute.For<IGameRandom>();
                new TurnManager(new List<Player>(), mockRandom, Utilities.TestLogger.Instance);
        ...
        public void EndTurn_SwitchesActivePlayer()
        {
            ...
            var mockRandom = Substitute.For<IGameRandom>();
            var manager = new TurnManager(new List<Player> { p1, p2 }, mockRandom, Utilities.TestLogger.Instance);
