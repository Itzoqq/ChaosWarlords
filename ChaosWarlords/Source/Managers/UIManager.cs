...
namespace ChaosWarlords.Source.Managers
{
    public class UIManager : IUIManager
    {
        ...
        public UIManager(int screenWidth, int screenHeight, IGameLogger logger)
        {
        ...
        private void InitializeInteractiveElements()
        {
            ...
            [
                ...
                new InteractiveElement
                {
                    ...
                    OnClick = () => { _logger.Log("UI: Resume Clicked", LogChannel.Info); OnResumeRequest?.Invoke(this, EventArgs.Empty); },
                    IsActive = () => IsPaused
                },
                new InteractiveElement
                {
                    ...
                    OnClick = () => { _logger.Log("UI: MainMenu Clicked", LogChannel.Info); OnMainMenuRequest?.Invoke(this, EventArgs.Empty); },
                    IsActive = () => IsPaused
                },
                new InteractiveElement
                {
                    ...
                    OnClick = () => { _logger.Log("UI: Exit Clicked", LogChannel.Info); OnExitRequest?.Invoke(this, EventArgs.Empty); },
                    IsActive = () => IsPaused
                },
