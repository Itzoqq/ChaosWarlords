...
namespace ChaosWarlords.Source.Utilities
{
    public static class MapGeometry
    {
        ...
        public static bool TryGetLineIntersection(ChaosWarlords.Source.Core.Data.LogicVector2 p1, ChaosWarlords.Source.Core.Data.LogicVector2 p2, ChaosWarlords.Source.Core.Data.LogicVector2 p3, ChaosWarlords.Source.Core.Data.LogicVector2 p4, out ChaosWarlords.Source.Core.Data.LogicVector2 result)
        {
            result = ChaosWarlords.Source.Core.Data.LogicVector2.Zero;
            ...
            if (uaValid && ubValid)
            {
                ...
                result = new ChaosWarlords.Source.Core.Data.LogicVector2(
                    p1.X + (int)offsetX,
                    p1.Y + (int)offsetY
                );
                return true;
